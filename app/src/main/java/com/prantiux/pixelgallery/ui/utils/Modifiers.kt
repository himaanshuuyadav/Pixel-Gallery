...
/**
 * Adds a bouncy scale animation when the user presses down on the composable.
 */
...
/**
 * Adds a shimmering effect to the composable for use in skeletal loading screens.
 */
