...
import com.prantiux.pixelgallery.domain.model.editor.PainterMotionEvent
...
import com.prantiux.pixelgallery.ui.screens.edit.refra.utils.dragMotionEvent
                        ...
                        if (latestSelectedTextIndex in latestTextAnnotations.indices) {
                            ...
                            if (corner == 0) {
                                ...
                                rotateStartAngle = kotlin.math.atan2(
                                    (pos.y - bounds.center.y).toDouble(),
                                    (pos.x - bounds.center.x).toDouble()
                                ).toFloat()
