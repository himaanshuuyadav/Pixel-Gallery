...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_6_7 = object : Migration(6, 7) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // Create composite index for album views (bucketId + dateAdded)
                db.execSQL("CREATE INDEX IF NOT EXISTS index_media_bucketId_dateAdded ON media(bucketId, dateAdded)")
            }
        }
