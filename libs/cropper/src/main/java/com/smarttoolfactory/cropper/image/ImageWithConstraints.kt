...
internal fun ImageWithConstraints(
    ...
    BoxWithConstraints(
        ...
        val horizontalPaddingPx = with(LocalDensity.current) {
            ...
            contentPadding.calculateRightPadding(androidx.compose.ui.unit.LayoutDirection.Ltr)).roundToPx()
        }

        val safeBoxWidth = boxWidth - horizontalPaddingPx
        val safeBoxHeight = boxHeight - topPaddingPx - bottomPaddingPx
        ...
        val dstSize = Size(safeBoxWidth.toFloat(), safeBoxHeight.toFloat())
        ...
        val bitmapRect = getScaledBitmapRect(
            ...
            IntRect(it.left, it.top + offsetY, it.right, it.bottom + offsetY)
        }
